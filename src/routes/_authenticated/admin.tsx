...
function AdminPage() {
  const t = useT();
    ...
    const byRegion = [
      ...
      { region: "Gweru", emergencies: 92 }, { region: "Masvingo", emergencies: 71 }, { region: "Vic Falls", emergencies: 38 },
    ];
    return (
      <AppShell>
        ...
        <div className="mb-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <Kpi icon={<Ambulance className="h-4 w-4 text-primary" />} value="82%" label="Ambulance utilisation" />
          <Kpi icon={<Users className="h-4 w-4 text-primary" />} value="14,382" label="Registered users" />
        </div>
            ...
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={responseTimes}>
                  ...
                  <Line type="monotone" dataKey="minutes" stroke="var(--medical)" strokeWidth={2.5} dot={{ r: 3 }} />
                </LineChart>
              </ResponsiveContainer>
            </div>
          </div>
